...
dataset= r'C:\Users\86151\Desktop\TiO2\Absorb\TiO2train2.xlsx'
...
best_score = 0.0
for alpha in [0.031,0.032,0.03,0.033,0.029,0.028,0.027,0.026,0.025,0.024,0.023,0.022,0.021,0.02]:
     for max_iter in [100,200,300,500,1000]:
    #     for min_samples_leaf in [1,2,3]:
    #         for min_samples_split in [2, 3,4,5,6,7,8]:
               lrtool = Lasso(alpha=alpha,max_iter=max_iter)  # 对于每种参数可能的组合，进行一次训练；
               lrtool.fit(X_train, y_train)
